...
import ReleaseIndex from "../../view/release/index";
...
const TabRouteConfigs = {  // 表示各个页面路由配置,让导航器知道需要导航的路由对应的页面
    Home: {  // 路由名称
        screen: ReleaseIndex,  // 对应的路由页面
        navigationOptions: {  // 指定路由页面的配置选项
            // tabBarLabel: '新闻',   // 表示tab的标题
            title: '技术',  // 可用作头部标题 headerTitle ，或者Tab标题 tabBarLabel
        },
    },
...
const TabNavigatorConfigs = {
    ...
    tabBarOptions: {
        ...
        indicatorStyle: {height: 0,backgroundColor:'#9DA5AD'},
